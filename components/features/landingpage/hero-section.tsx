  ...
  return (
    <section className="px-14 flex py-20 justify-between font-poppins items-center gap-6">
      <div className="grid gap-5 w-6/12">
        <header className="grid gap-2">
          ...
          <p className="text-base text-foreground/50">
            Discover, purchase, and access cutting-edge research materials. Get
            professional guidance for your academic projects.
          </p>
        </header>
      ...
      <div className="w-6/12 relative max-w-[500px] h-[500px] ">
        ...
        <div className="rounded-lg bg-primary/10 absolute top-[30%] -left-[20%]  py-2 px-4 translate-y-1/2 border-2 z-10 -rotate-20 text-center">
        ...
        <div className="rounded-lg bg-primary/10 absolute bottom-[15%] -right-[5%]  py-2 px-4 translate-y-1/2 border-2 z-10 rotate-20 text-center">
          <h3 className="text-foreground font-medium text-xs">
            Academic materials at your finger tip!
          </h3>
          <p className="text-foreground/80 text-xs">
